...
import { Bell, Bot, CheckCircle2, Key, Lightbulb, Plus, Save, Settings2, Timer, Trash2, Zap } from "lucide-react";
  ...
  return (
    <div>
      <PageSection
        ...
        description="Set platform-wide defaults and personal AI behaviour."
      />
      <Tabs
