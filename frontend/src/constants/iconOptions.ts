// Lucide icon options (matches what seed.js stores). Shared across any form
// that lets an admin pick a Lucide React icon component name — currently
// used by menus/page.tsx, specialities/page.tsx, and TenantSpecialitiesPanel.
export const ICON_OPTIONS = [
  ...
  // Medical & Health
  "Heart", "HeartPulse", "Stethoscope", "Pill", "Syringe", "Thermometer", "Cross", "Ambulance", "Brain", "Microscope", "BadgePlus",
  // Navigation & Actions
